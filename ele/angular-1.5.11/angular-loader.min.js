...
(function () {
    ...
    function g(a, c) {
        ...
        return function () {
            var d = arguments[0], f;
            f = "[" + (a ? a + ":" : "") + d + "] http://errors.angularjs.org/1.5.11/" + (a ? a + "/" : "") + d;
            for (d = 1; d < arguments.length; d++) {
                f = f + (1 == d ? "?" : "&") + "p" + (d - 1) + "=";
                var n = encodeURIComponent, b;
                b = arguments[d];
    ...
    (function (a) {
        ...
        return c(a, "module", function () {
            ...
            return function (b, g, k) {
                if ("hasOwnProperty" === b)throw f("badname", "module");
                g && a.hasOwnProperty(b) && (a[b] = null);
                return c(a, b, function () {
                    function a(b, d, c, e) {
                        e || (e = f);
                        return function () {
                            e[c || "push"]([b, d, arguments]);
                            return h
                        }
                    }
                    ...
                    function e(a, d) {
                        return function (e, c) {
                            c && "function" === typeof c && (c.$$moduleName = b);
